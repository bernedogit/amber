...
# Object dependencies.
bin/altsig.o bin/altsig-pic.o : test/altsig.cpp src/soname.hpp  \
	src/symmetric.hpp  src/misc.hpp  src/blake2.hpp  src/group25519.hpp  \
	src/field25519.hpp  src/hasopt.hpp  
...
bin/field_test.o bin/field_test-pic.o : test/field_test.cpp src/hasopt.hpp  \
	src/soname.hpp  src/field25519.hpp  
...
bin/twcmp.o bin/twcmp-pic.o : test/twcmp.cpp src/field25519.hpp  \
...
# Main programs
bin/altsig: \
	bin/sha2.o bin/poly1305.o bin/altsig.o bin/field25519.o bin/symmetric.o  \
	bin/hasopt.o bin/misc.o bin/group25519.o bin/blake2.o

bin/altsig-pic: \
	bin/sha2-pic.o bin/poly1305-pic.o bin/altsig-pic.o bin/field25519-pic.o  \
	bin/symmetric-pic.o bin/hasopt-pic.o bin/misc-pic.o  \
...
FULL_TARGETS =  bin/altsig bin/amber bin/blake2_test bin/blakerng bin/blockbuf_test  \
	...
	bin/tamper bin/twcmp bin/tweetcmd bin/wipe
