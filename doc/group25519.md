...
verification, the differences are around 1%. This is negligible and we can
select whatever representation best fits the current needs. We mention below
the main features of each representation:
...
X25519:    Simple, widely used. Does not allow the recovery of the full point.
		   ...
		   for keys used for encryption (DH) and signatures.
